.class Lcom/sonymobile/photopro/interaction/TouchActionTranslator$SingleMove;
...
.method private constructor <init>(Lcom/sonymobile/photopro/interaction/TouchActionTranslator;)V
    ...
    .line 349
    iput-object p1, p0, Lcom/sonymobile/photopro/interaction/TouchActionTranslator$SingleMove;->this$0:Lcom/sonymobile/photopro/interaction/TouchActionTranslator;
...
.method synthetic constructor <init>(Lcom/sonymobile/photopro/interaction/TouchActionTranslator;Lcom/sonymobile/photopro/interaction/TouchActionTranslator$1;)V
    ...
    .line 349
    invoke-direct {p0, p1}, Lcom/sonymobile/photopro/interaction/TouchActionTranslator$SingleMove;-><init>(Lcom/sonymobile/photopro/interaction/TouchActionTranslator;)V
...
.method public handleMotionEvent(Landroid/view/MotionEvent;)V
    ...
    .line 368
    :cond_1
    iget-object v0, p0, Lcom/sonymobile/photopro/interaction/TouchActionTranslator$SingleMove;->this$0:Lcom/sonymobile/photopro/interaction/TouchActionTranslator;
    ...
    .line 371
    iget-object p1, p0, Lcom/sonymobile/photopro/interaction/TouchActionTranslator$SingleMove;->this$0:Lcom/sonymobile/photopro/interaction/TouchActionTranslator;

    new-instance v0, Lcom/sonymobile/photopro/interaction/TouchActionTranslator$DoubleDown;

    iget-object p0, p0, Lcom/sonymobile/photopro/interaction/TouchActionTranslator$SingleMove;->this$0:Lcom/sonymobile/photopro/interaction/TouchActionTranslator;
...
.method public handleSingleTouchMoveEvent(Landroid/graphics/Point;Landroid/graphics/Point;Landroid/graphics/Point;)V
    ...
    invoke-interface {p0, p1, p2, p3}, Lcom/sonymobile/photopro/interaction/TouchActionTranslator$TouchActionListener;->onSingleMoved(Landroid/graphics/Point;Landroid/graphics/Point;Landroid/graphics/Point;)V
...
.method public handleSingleTouchStopEvent(Landroid/graphics/Point;Landroid/graphics/Point;Landroid/graphics/Point;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/sonymobile/photopro/interaction/TouchActionTranslator$TouchActionListener;->onSingleStopped(Landroid/graphics/Point;Landroid/graphics/Point;Landroid/graphics/Point;)V

    .line 386
    iget-object p1, p0, Lcom/sonymobile/photopro/interaction/TouchActionTranslator$SingleMove;->this$0:Lcom/sonymobile/photopro/interaction/TouchActionTranslator;

    new-instance p2, Lcom/sonymobile/photopro/interaction/TouchActionTranslator$SingleStop;

    iget-object p0, p0, Lcom/sonymobile/photopro/interaction/TouchActionTranslator$SingleMove;->this$0:Lcom/sonymobile/photopro/interaction/TouchActionTranslator;

    const/4 p3, 0x0

    invoke-direct {p2, p0, p3}, Lcom/sonymobile/photopro/interaction/TouchActionTranslator$SingleStop;-><init>(Lcom/sonymobile/photopro/interaction/TouchActionTranslator;Lcom/sonymobile/photopro/interaction/TouchActionTranslator$1;)V
